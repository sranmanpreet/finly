...
const ChartIncomeVsExpense: React.FC<ChartIncomeVsExpenseProps> = ({ incomeVsExpense }) => (
  ...
  <h2 className="text-base font-semibold mb-1">Credit vs Debit Over Time</h2>
  ...
  <Line type="monotone" dataKey="credit" stroke="#4ade80" strokeWidth={2} dot={false} />
  <Line type="monotone" dataKey="debit" stroke="#f87171" strokeWidth={2} dot={false} />
      </LineChart>
    </ResponsiveContainer>
  </div>
);
